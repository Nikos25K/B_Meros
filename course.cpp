...
Course::Course(const int ects, bool mand, const int sem): ECTS(ects), mandatory(mand), semester(sem){}

Course::Course(const Course& course) : ECTS(course.ECTS), mandatory(course.mandatory), semester(course.semester){}
